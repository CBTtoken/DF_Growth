...
import { Hero } from "@/components/custom-pages/katisobiz-nomads/Hero";
import { About } from "@/components/custom-pages/katisobiz-nomads/About";
import { Benefits } from "@/components/custom-pages/katisobiz-nomads/Benefits";
import { FacebookGroups } from "@/components/custom-pages/katisobiz-nomads/FacebookGroups";
import { Closing } from "@/components/custom-pages/katisobiz-nomads/Closing";
...
// community page that existed before the rename, laid out fresh rather than ported
...
export function KatisoBizNomadsPage({ clientId, businessName, metaPixelId, landingPageId, contactEmail }: CustomPageProps) {
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL ?? ""}/katisobiz-nomads`;
