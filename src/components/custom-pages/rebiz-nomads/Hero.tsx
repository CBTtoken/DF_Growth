...
// WhatsApp is reserved as a Growth onboarding entry channel, and KatisoBiz
// Nomads is not joined independently, it is a bundled benefit of Growth
...
export function Hero() {
  return (
    ...
    // Everything below still alternates white and tinted, but the opening
