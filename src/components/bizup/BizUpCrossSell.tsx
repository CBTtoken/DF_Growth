 ...
 * way to discover BizUp at all: the only connection anywhere in the app was
 * a redirect for members who had BizUp and nothing else.
 *
  ...
  return (
    <section className="rounded-2xl border border-brand/20 bg-brand/5 p-5">
      <div className="flex flex-wrap items-baseline justify-between gap-2">
        <h2 className="text-base font-bold text-ink">BizUp, quoting and invoicing</h2>
      ...
      <p className="mt-2 text-sm text-gray-500">
        {includedPaid
          ...
          : "Your plan includes BizUp Free: 10 documents a month. You can add the full tier for R49 whenever you want it, without changing your Growth plan."}
      </p>
      ...
      >
        {hasBizUpAccount ? "Go to BizUp" : "Set up BizUp"}
      </Link>
    </section>
  );
}
...
export function GrowthFromBizUp() {
  return (
    <section className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
      ...
      <p className="mt-2 text-sm leading-relaxed text-gray-600">
        BizUp helps you win the jobs you are already quoting for. DigitalFlyer Growth is the other
      ...
      <p className="mt-2 text-sm text-gray-500">
        BizUp is included when you join, so you keep everything you have set up here.
      </p>
      <a
