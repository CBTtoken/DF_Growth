...
export default async function ClientLandingPage({
  ...
  const { data: client } = await admin
    .from("growth_clients")
    .select(
      `id, business_name, contact_email, call_phone, whatsapp_phone, brand_primary_color, brand_secondary_color, tagline, business_address, packages, logo_path, additional_notes, facebook_url, instagram_url, website_url, template, industry, city, province, meta_pixel_id, hero_photo_id, hide_call_button, booking_enabled, shop_enabled, shop_flat_delivery_cents, shop_free_delivery_over_cents, fallback_photo_url,
