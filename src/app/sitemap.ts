...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  if (isSvcHost(host)) {
    ...
    return [
      ...
      { url: `${svcUrl}/help/dashboard`, changeFrequency: "monthly", priority: 0.6 },
      { url: `${svcUrl}/help/coupons-arrive`, changeFrequency: "monthly", priority: 0.6 },
      { url: `${svcUrl}/help/coupons-use`, changeFrequency: "monthly", priority: 0.6 },
