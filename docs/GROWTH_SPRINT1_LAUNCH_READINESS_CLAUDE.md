...
*This spec covers Sprint 1 build items only. Sprint 2 and 3 items (further SEO acceleration, homepage flow improvements, KatisoBiz Nomads push, Enterprise scoping) will be handed to Claude Code separately once Sprint 1 is complete and reviewed.*
