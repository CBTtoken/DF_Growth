...
| **Custom pages (x3)** | Standing 365 (order flow, live payment, seller-side order dashboard, and — new — Booking, verified against real test slots), KatisoBiz Nomads, and Buffelskop (real client, own bulk-pricing flow) |
